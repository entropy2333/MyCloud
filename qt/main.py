...
LITGHT_FUNF_COLOR = '#FFFFF0'  # 到功能栏颜色的过渡色
...
class Main_window(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.left_column = ['allfile_btn', 'doc_btn', 'img_btn', 'music_btn', 'video_btn', 'other_btn']  # 左边栏
        ...
        Qss += 'QPushButton#user_btn{background-color:%s; border:none; border-radius:10px; text-align:left}' % TITLE_COLOR
        ...
        for btn in self.left_column:
            ...
            Qss += '#%s:hover{background-color:%s; border-radius:0;}' % (btn, LITGHT_FUNF_COLOR)
        ...
        self.user_icon.setPixmap(QPixmap(f'{ABSOLUTE_PATH}/img/user.png').scaled(self.user_icon.width(), self.user_icon.height()))
