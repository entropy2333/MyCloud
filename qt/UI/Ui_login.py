...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(110, 150, 101, 31))
        font = QtGui.QFont()
        font.setFamily("幼圆")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(250, 150, 101, 31))
        font = QtGui.QFont()
        font.setFamily("幼圆")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(40, 30, 271, 90))
